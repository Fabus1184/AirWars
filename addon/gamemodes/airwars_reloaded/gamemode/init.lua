...
function GM:PlayerSpawn(player)
	...
	for _, v in pairs(global_config.categories[CATEGORY_DICKE_ZUGRIFF_WAFFEN].props) do
		table.insert(allowed_weapons, v.weapon)
	end

	for k, v in pairs(player:GetWeapons()) do
		if !table.HasValue(allowed_weapons, v:GetClass()) then
