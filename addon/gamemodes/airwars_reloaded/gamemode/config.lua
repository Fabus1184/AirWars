...
CATEGORY_WEAPONS = 3
CATEGORY_FLAGS = 4
CATEGORY_DICKE_ZUGRIFF_WAFFEN = 5
...
global_config.categories[CATEGORY_DICKE_ZUGRIFF_WAFFEN] = {}
global_config.categories[CATEGORY_DICKE_ZUGRIFF_WAFFEN].name = "Dicke Zugriff Waffen"
global_config.categories[CATEGORY_DICKE_ZUGRIFF_WAFFEN].props = {
	{
		weapon = "weapon_rpg",
		ammo = 8,
		amount = 1,
